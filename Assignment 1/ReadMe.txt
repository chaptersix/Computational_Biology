...
Usage Examples:
    python alignment_implementation.py pair1\1k4rA_dengue_virus.fasta pair1\5ire_zika_virus.fasta results_pair1.txt
    python alignment_implementation.py pair2\1dzl_HPV.fasta pair2\3mge_HIV.fasta results_pair2.txt
    python alignment_implementation.py pair3\2plv1_polio_virus.fasta pair3\4rhv1_rhino_virus.fasta results_pair3.txt
